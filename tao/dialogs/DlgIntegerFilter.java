...
public class DlgIntegerFilter extends TaoDialog {
	public TaoIntegerFilter result = new TaoIntegerFilter();
	private DlgIntegerFilter dlg;
	...
	public DlgIntegerFilter(TaoIntegerFilter aIntegerFilter, String aCaption) {
		...
		spValue1 = getNewIntField();
		spValue2 = getNewIntField();
		...
		if (aIntegerFilter != null) {
		cmbOper1.setSelectedIndex(aIntegerFilter.oper1);
		cmbOper2.setSelectedIndex(aIntegerFilter.oper2);
		cmbOper3.setSelectedIndex(aIntegerFilter.oper3);
		spValue1.setValue(aIntegerFilter.value1);
		spValue2.setValue(aIntegerFilter.value2);
		}
		updateControls();
	}
	...
	class AcOk extends AbstractAction {
		...
		public void actionPerformed(ActionEvent event) {
			...
			dlg.result.value1 = (Integer)spValue1.getValue();
			dlg.result.oper2 = cmbOper2.getSelectedIndex();
			dlg.result.oper3 = cmbOper3.getSelectedIndex();
			dlg.result.value2 = (Integer)spValue2.getValue();
